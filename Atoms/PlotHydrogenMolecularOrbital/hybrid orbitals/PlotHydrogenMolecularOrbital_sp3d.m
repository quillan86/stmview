...
function PlotHydrogenMolecularOrbital_sp3d
%--------------------------------------------------------------------------
...
% cons.cutoff     = 2.2 * 10^(26); % electron density cutoff (where to put isosurface)
...
WaveFn_sp3d_1 = sqrt(1/3) * (WaveFn_3s + sqrt(2)*WaveFn_3px);
WaveFn_sp3d_2 = sqrt(1/3) * (WaveFn_3s - sqrt(1/2)*WaveFn_3px + sqrt(3/2)*WaveFn_3py);
WaveFn_sp3d_3 = sqrt(1/3) * (WaveFn_3s - sqrt(1/2)*WaveFn_3px - sqrt(3/2)*WaveFn_3py);
WaveFn_sp3d_4 = sqrt(1/2) * (WaveFn_3pz + WaveFn_3d0);
WaveFn_sp3d_5 = sqrt(1/2) * (WaveFn_3pz - WaveFn_3d0);


cons.cutoff     = 4.9 * 10^(27);
subplot(2,3,1);
WaveFn = WaveFn_sp3d_1;
cons.orbitName   = 'sp3d_1';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);

subplot(2,3,2);
WaveFn = WaveFn_sp3d_2;
cons.orbitName   = 'sp3d_2';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);

subplot(2,3,3);
WaveFn = WaveFn_sp3d_3;
cons.orbitName   = 'sp3d_3';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);


cons.cutoff     = 2.2 * 10^(24);
subplot(2,3,4);
WaveFn = WaveFn_sp3d_4;
cons.orbitName   = 'sp3d_4';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);

subplot(2,3,5);
WaveFn = WaveFn_sp3d_5;
cons.orbitName   = 'sp3d_5';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);
end
