...
function PlotHydrogenMolecularOrbital_sp3d2
%--------------------------------------------------------------------------
% define constants and orbital shape

% quantum numbers
n = 3;           % principal quantum number (shell #)
...
cons.cutoff     = 3.0 * 10^(27); % electron density cutoff (where to put isosurface)
cons.resolution = 125;             % number of calculations per XYZ dimension   
cons.spatialLen = 13;             % length of physical space to view over (angstroms)
...
%                   x    y    x     y
figure('Position', [100, 500, 1100, 1100]);

l = 0;
m = 0;
WaveFn_3s = psiCalculation(n,l,m,r,theta,phi,cons);

l = 1;
m = 0;
WaveFn_3px = psiCalculation(n,l,m,r,theta,phi,cons);

l = 1;
m = 1;
WaveFn_3py = psiCalculation(n,l,m,r,theta,phi,cons);

l = 1;
m = -1;
WaveFn_3pz = psiCalculation(n,l,m,r,theta,phi,cons);

l = 2;
m = 0;
WaveFn_3d0 = psiCalculation(n,l,m,r,theta,phi,cons);

l = 2;
m = -2;
WaveFn_3dm2 = psiCalculation(n,l,m,r,theta,phi,cons);


WaveFn_sp3d2_1 = sqrt(1/6) * (WaveFn_3s + sqrt(3)*WaveFn_3pz + sqrt(2)*WaveFn_3d0);
WaveFn_sp3d2_2 = sqrt(1/6) * (WaveFn_3s + sqrt(3)*WaveFn_3pz - sqrt(1/2)*WaveFn_3d0 + sqrt(3/2)*WaveFn_3dm2);
WaveFn_sp3d2_3 = sqrt(1/6) * (WaveFn_3s + sqrt(3)*WaveFn_3pz - sqrt(1/2)*WaveFn_3d0 - sqrt(3/2)*WaveFn_3dm2);
WaveFn_sp3d2_4 = sqrt(1/6) * (WaveFn_3s - sqrt(3)*WaveFn_3pz - sqrt(1/2)*WaveFn_3d0 + sqrt(3/2)*WaveFn_3dm2);
WaveFn_sp3d2_5 = sqrt(1/6) * (WaveFn_3s - sqrt(3)*WaveFn_3pz - sqrt(1/2)*WaveFn_3d0 - sqrt(3/2)*WaveFn_3dm2);
WaveFn_sp3d2_6 = sqrt(1/6) * (WaveFn_3s - sqrt(3)*WaveFn_3pz + sqrt(2)*WaveFn_3d0);


subplot(2,3,1);
WaveFn = WaveFn_sp3d2_1;
cons.orbitName   = 'sp3d2_1';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);

subplot(2,3,2);
WaveFn = WaveFn_sp3d2_2;
cons.orbitName   = 'sp3d2_2';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);

subplot(2,3,3);
WaveFn = WaveFn_sp3d2_3;
cons.orbitName   = 'sp3d2_3';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);

subplot(2,3,4);
WaveFn = WaveFn_sp3d2_4;
cons.orbitName   = 'sp3d2_4';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);

subplot(2,3,5);
WaveFn = WaveFn_sp3d2_5;
cons.orbitName   = 'sp3d2_5';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);

subplot(2,3,6);
WaveFn = WaveFn_sp3d2_6;
cons.orbitName   = 'sp3d2_6';
PlotWaveFnSignIsosurface(xSpace, ySpace, zSpace, WaveFn, cons);
