...
function PlotHydrogenMolecularOrbital_sp
%--------------------------------------------------------------------------
...
cons.cutoff     = 3.5 * 10^(28); % electron density cutoff (where to put isosurface)
...
WaveFn_sp_1 = sqrt(1/2) * (WaveFn_2s + WaveFn_2pz);
WaveFn_sp_2 = sqrt(1/2) * (WaveFn_2s - WaveFn_2pz);
