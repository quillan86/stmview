...
function PlotHydrogenMolecularOrbital_4f
%--------------------------------------------------------------------------
% define constants and orbital shape

% quantum numbers
n = 4;           % principal quantum number (shell #)
l = 3;           % orbital quantum number (subshell type: s, p, d, f, etc.)
...
cons.spatialLen = 6;             % length of physical space to view over (angstroms)
...
subplot(2,4,1);
m = -3;
WaveFn_4fm3 = psiCalculation(n,l,m,r,theta,phi,cons);
cons.orbitName   = orbitNameIs(n,l,m);
PlotCrossSectionIsosurface(xSpace, ySpace, zSpace, WaveFn_4fm3, cons);
fprintf('done with plot 1\n');

subplot(2,4,2);
m = -2;
WaveFn_4fm2 = psiCalculation(n,l,m,r,theta,phi,cons);
cons.orbitName   = orbitNameIs(n,l,m);
cons.sliceStyle2 = true;
PlotCrossSectionIsosurface(xSpace, ySpace, zSpace, WaveFn_4fm2, cons);
fprintf('done with plot 2\n');

subplot(2,4,3);
m = -1;
WaveFn_4fm1 = psiCalculation(n,l,m,r,theta,phi,cons);
cons.orbitName   = orbitNameIs(n,l,m);
cons.sliceStyle2 = false;
PlotCrossSectionIsosurface(xSpace, ySpace, zSpace, WaveFn_4fm1, cons);
fprintf('done with plot 3\n');

subplot(2,4,4);
m = 0;
WaveFn_4f0 = psiCalculation(n,l,m,r,theta,phi,cons);
cons.orbitName   = orbitNameIs(n,l,m);
PlotCrossSectionIsosurface(xSpace, ySpace, zSpace, WaveFn_4f0, cons);
fprintf('done with plot 4\n');

subplot(2,4,5);
m = 1;
WaveFn_4f1 = psiCalculation(n,l,m,r,theta,phi,cons);
cons.orbitName   = orbitNameIs(n,l,m);
PlotCrossSectionIsosurface(xSpace, ySpace, zSpace, WaveFn_4f1, cons);
fprintf('done with plot 5\n');

subplot(2,4,6);
m = 2;
WaveFn_4f2 = psiCalculation(n,l,m,r,theta,phi,cons);
cons.orbitName   = orbitNameIs(n,l,m);
PlotCrossSectionIsosurface(xSpace, ySpace, zSpace, WaveFn_4f2, cons);
fprintf('done with plot 6\n');

subplot(2,4,7);
m = 3;
WaveFn_4f3 = psiCalculation(n,l,m,r,theta,phi,cons);
cons.orbitName   = orbitNameIs(n,l,m);
PlotCrossSectionIsosurface(xSpace, ySpace, zSpace, WaveFn_4f3, cons);
fprintf('done with plot 7\n');

subplot(2,4,8);
WaveFn = WaveFn_4fm3 + WaveFn_4fm2 + WaveFn_4fm1 + WaveFn_4f0 + WaveFn_4f1 + WaveFn_4f2 + WaveFn_4f3;
cons.orbitName   = '4f summation';
