...
for i = 1:9
    ...
    eval(['fdata.xaxis' num2str(i) ' = [];']);
    
    %eval(['fdata.xaxis' num2str(i) ' = [];']);
    %eval(['fdata.yaxis' num2str(i) ' = [];']);
end
...
%axis_bnd_init.x = get(img1_axes,'xlim');
%axis_bnd_init.y = get(img1_axes,'ylim');
...
% %%%%%%%%%%%%%%%%%%%%%% CALLBACK FUNCTIONS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function export_Callback(hObject,eventdata)
        ...
        if isempty(filename)
            ...
            exp_movie_multipanel_mac(fdata,n_row,n_col,directory,filename,frps,quality);
        end
    end
% 
