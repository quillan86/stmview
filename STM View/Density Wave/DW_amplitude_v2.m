...
[nr nc nz] = size(data.map);    
    ...
    if opt(1) == 1
        ...
        sff_DW_amp = sff_DW_amp_Q1;
        sff_DW_amp.map = sff_DW_amp_Q1.map + sff_DW_amp_Q2.map;
        sff_DW_amp.var = 'sFF_DW_amp';
        sff_DW_amp.ave = avg_map(sff_DW_amp.map);
        IMG(sff_DW_amp);
    end
    ...
    if opt(2) == 1
        ...
        spff_DW_amp = spff_DW_amp_Q1;
        spff_DW_amp.map = spff_DW_amp_Q1.map + spff_DW_amp_Q2.map;
        spff_DW_amp.var = 's`FF_DW_amp';
        spff_DW_amp.ave = avg_map(spff_DW_amp.map);
        IMG(spff_DW_amp);
    end
    ...
    if opt(3) == 1
        ...
        dff_DW_amp.var = 'dFF_DW_amp';
        dff_DW_amp.ave = avg_map(dff_DW_amp.map);
        IMG(dff_DW_amp);
    end
