function DW_amplitude_dialogue(data)
...
%form factors
fh=figure('Name', 'Form Factor DW Amplitude - DW Q vectors + Filter Width',...
        'units','normalized', ...
...
function OK_Callback(hObject,eventdata)
    ...
    DW_amplitude_v2(q_px,filt_w,data,[s_opt sp_opt d_opt]);
end
