function data_histogram_dialogue(layer,histo,fig_handle,axis_handle)
...
done_but = uicontrol(fh,'Style','pushbutton',...
                          'String','DONE',...
                          'units','centimeter',...
                          'Position',[14.2 5 2.5 1],...
                          'Callback',(@done_Callback));

clim_choice = uibuttongroup('Position',[0.79 0.55 .165 0.17],...
                            'Title','Threshold By: ',...
...
u0 = uicontrol('Style','Radio','String','Relative',...
    'pos',[10 25 65 25],'parent',clim_choice,'HandleVisibility','off');
u1 = uicontrol('Style','Radio','String','Absolute',...
    'pos',[10 0 65 25],'parent',clim_choice,'HandleVisibility','off');
