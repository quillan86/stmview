...
for i=1:step_n        
    ...
    for j=1:(avg_px)
        ...
        hold on; plot([avg_pts(1,k) avg_pts(1,k+1)],[avg_pts(2,k) avg_pts(2,k+1)],'.');
        %avg_pts = round(avg_pts);
        %hold on; plot([avg_pts(1,k) avg_pts(1,k+1)],[avg_pts(2,k) avg_pts(2,k+1)],'r.');
    end
%     for j=1:(avg_px)
