...
% 
function transform = linear2D_image_correct_square(pt1,pt2,pt3,pt4,data,varargin)
% 
...
A = [pt1(1) pt1(2); pt2(1) pt3(2);pt3(1) pt4(2);pt4(1) pt4(2)];
%A = [quadrant 1(x,y); quadrant 2(x,y); quadrant 3(x,y); quadrant 4(x,y)];

%Use the mean locations to generate a square
