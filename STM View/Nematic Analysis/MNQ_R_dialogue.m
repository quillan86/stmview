...
filter = uicontrol(fh,'Style','edit',...
        'units','normalized',...
...
%%%%%%%%%%%%%%%%%%%%%%%%CALLBACK FUNCTIONS%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function OK_Callback(hobject,eventdata)
        ...
        filter_sz = str2num(get(filter,'String'));
        new_img = MNQ_R(data,pt1,pt2,filter_sz);
        new_data = data;
        new_data.map = new_img;
        new_data.ave = [];
        new_data.var = 'MNQ(r)';
        new_data.ops{end+1} = ['MNQ(r) Calculation: Bragg Peaks (' num2str(pt1(1)) ' ' num2str(pt1(2)) ', (' num2str(pt2(1)) ' ' num2str(pt2(2)) ') Filter size(pixels) ' num2str(filter_sz) ];
