...
for i = 1:size(Cu_index,1);   
    for n = 1:range              
        r_tmp = 0; c_tmp = 0;
        if (Cu_index(i,1)<= range || Cu_index(i,2) >= nc-range )
            break;
...
for i = 1:size(Cu_index,1)    
    for n = 1:range           
        r_tmp = 0; c_tmp = 0;
        if (Cu_index(i,1)>= nr-range || Cu_index(i,2) <= range)
            break;
...
for i = 1:size(Cu_index,1)    
    for n = 1:range   
        r_tmp = 0; c_tmp = 0;
        if (Cu_index(i,1)>= nr-range || Cu_index(i,2) >= nc-range)
            break;
...
for i = 1:size(Cu_index,1)        
    for n = 1:range           
        r_tmp = 0; c_tmp = 0;
        if (Cu_index(i,1)<= range || Cu_index(i,2) <= range)
            break;
