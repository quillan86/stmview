...
% added gray scale of colormap	
% and better directory recognition	G.K. Mar 2000		1.0-->1.1
...
ColEditAx(4) = axes('position',[0.3,0.84,0.65,0.08]);	% colormap
ColEditAx(5) = axes('position',[0.3,0.93,0.65,0.05]);	% b/w colormap
